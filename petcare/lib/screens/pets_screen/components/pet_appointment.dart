...
final serviceRef = (String id, String serviceId) => FirebaseFirestore.instance
    .collection('stores/$id/services/$serviceId')
...
final petRef = (String id) => FirebaseFirestore.instance
...
Future getServiceList(String id, String serviceId) async {
  QuerySnapshot serviceDetail = (await serviceRef(id, serviceId).get());
  print(serviceDetail.size);
  return serviceDetail.docs;
}

Future getUserDetail(String id) async {
  QuerySnapshot petDetail = (await petRef(id).get());
                      ...
                      return Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            FutureBuilder(
                              future:
                                  getStoreDetail(snapshot.data[0]["storeId"]),
