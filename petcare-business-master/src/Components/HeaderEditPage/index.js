    ...
    <div className="header-edit">
      <div className="container-options">
        <div id="left-actions-mini-menu" className="left-actions">
          <a href="/requests" className={`tabnav ` + (requestsPage ? ('selected') : (''))}>
          ...
          <a href="/services" className={`tabnav ` + (services ? ('selected') : (''))}>
          ...
          <a href="/products" className={`tabnav ` + (editPage ? ('selected') : (''))}>
          ...
          <a href="/assessments" className={`tabnav ` + (evaluation ? ('selected') : (''))}>
          ...
          <a href="/settings" className={`tabnav ` + (configuration ? ('selected') : (''))}>
