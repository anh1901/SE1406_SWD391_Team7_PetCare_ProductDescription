        ...
        <div className="container-evaluation">
          <div className="header-list-evaluation">
            <div className="status-company-evalution">
              ...
              <div className="status-bar-evalution">
                <div /*style={{ marginLeft: (statusApproved ? ((statusApproved >= 90 ? (statusApproved - 18) : (statusApproved - 10))) : (0)) + '%' }} */ className="percent "><span>{statusApproved ? (statusApproved.toFixed(1)) : ('0')}% approval</span></div>
                <div className="bar-status-evaluation">
                  <div style={{ width: statusApproved + '%' }} className="bar-status" />
                </div>
                <div className="explanation">
                  <span className="icon">*</span>
                  <span className="text-explanation">This is the percentage of the maximum grade you could get if all users on this page had given it a 5.0!</span>
                </div>
              </div>
            </div>
          ...
          {isLoading? (<Loading />) : (
            <>
              ...
              <BottomLoadMore onClick={() => loadMoreEvaluations(actPage + 1)} text="Load More Reviews" setClassName="btn-loadMore-evaluation" />
            </>
          )}
        </div>
      </div>
