    ...
    <>
      ...
      <div className="container-page-sidebar">
        ...
        <div className="container-product">
          <SearchBox searchMethod={(e) => searchInList(e, "input-search-search-box", "container-list-products", "product", "title-product-area")} placeholder="Search for to product" />
          <div className="buttons">
            ...
            <a href="/register-product" className="signup-product">
          ...
          <div className="content-list">
            {/* {isLoading? (<Loading />) : (
              <>
                ...
                <BottomLoadMore text="Load More Products" onClick={() => handleLoadMoreProducts(actPage + 1)} />
              </>
            )} */}
              <p>In development...</p>
                <BottomLoadMore text="Load More Products" onClick={() => handleLoadMoreProducts(actPage + 1)} />
